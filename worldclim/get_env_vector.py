...
if __name__ == "__main__":
    DATA_PATH = "/Volumes/My Passport/South_Africa/worldclim"

    extractor = PatchExtractor(DATA_PATH, size = 1)
    ...
    df_ref.to_csv("/Volumes/My Passport/South_Africa/hotspots_info_with_bioclim_var.csv", index=False)